...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LSFT, MT(MOD_LSFT, KC_Z),     KC_X,           KC_C,           KC_V,          KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH, LT(3, KC_GRAVE),
                                                    MT(MOD_LGUI,KC_SPACE), MT(MOD_LALT, KC_SPACE),                                LT(2, KC_SPACE), LT(1,KC_ENTER)
  ),
  [1] = LAYOUT_voyager(
    ...
    _______,        _______, _______,        KC_ASTR,        KC_LPRN,        KC_RPRN,                                        _______, KC_LEFT, KC_DOWN, KC_RIGHT,        _______,       KC_ENTER ,
