...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LCTL, KC_A,    KC_S,        KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        MT(MOD_RSFT, KC_QUOTE),
    KC_LSFT, MT(MOD_LSFT, KC_Z),     KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         MT(MOD_RALT, KC_SLASH),KC_RSFT ,
                                                    MT(MOD_LALT,KC_BSPC), MT(MOD_LGUI, KC_SPACE),                                LT(2, KC_SPACE),LT(1,KC_ENTER)
  ),
  [1] = LAYOUT_voyager(
    _______,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,
    _______, KC_EXLM,        KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,                                        _______,   KC_UP,           _______,           KC_MINUS,       KC_SLASH,       KC_F12,
    QK_LLCK,        _______, KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RPRN,                                        KC_LEFT, KC_DOWN, KC_RIGHT, _______,        KC_ASTR,        KC_BSPC,
    _______, _______, KC_LBRC,        KC_RBRC,        KC_LCBR,        KC_RCBR,                                        _______,        _______,         _______,           KC_DOT,         KC_EQUAL,       KC_ENTER,
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_CAPS, KC_TRANSPARENT, KC_MS_BTN1,KC_MS_UP,KC_MS_BTN2,  KC_MS_WH_UP,                                 KC_TRANSPARENT,     KC_TRANSPARENT,        KC_TRANSPARENT,          KC_TRANSPARENT,         KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT,KC_MS_LEFT,KC_MS_DOWN,  KC_MS_RIGHT,KC_MS_BTN3,                                 KC_MS_BTN1,        KC_MS_BTN2,        KC_TRANSPARENT,        KC_TRANSPARENT,       KC_TRANSPARENT, KC_TRANSPARENT,
